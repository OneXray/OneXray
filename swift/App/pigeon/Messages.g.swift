...
protocol BridgeHostApi {
  func getTunFilesDir() async throws -> String
  func readVpnStatus() async throws -> NativeVpnCommandResult
  func startVpn() async throws -> NativeVpnCommandResult
  func stopVpn() async throws -> NativeVpnCommandResult
  func invoke(requestJson: String) async throws -> String
  func queryPlatformPermission() async throws -> PlatformPermissionResult
  func requestPlatformPermission() async throws -> PlatformPermissionResult
  func getInstalledApps() async throws -> [AndroidAppInfo]
  func useSystemExtension() async throws -> Bool
  func queryLaunchAtLogin() async throws -> NativeLaunchAtLoginResult
  func setLaunchAtLogin(enabled: Bool) async throws -> NativeLaunchAtLoginResult
  func openLaunchAtLoginSettings() async throws -> Bool
  func setAppIcon(appIcon: String) async throws -> Bool
  func getCurrentAppIcon() async throws -> String
}
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: BridgeHostApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      getTunFilesDirChannel.setMessageHandler { _, reply in
        Task { @MainActor in
          do {
            let result = try await api.getTunFilesDir()
    ...
    if let api = api {
      readVpnStatusChannel.setMessageHandler { _, reply in
        Task { @MainActor in
          do {
            let result = try await api.readVpnStatus()
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      startVpnChannel.setMessageHandler { _, reply in
        Task { @MainActor in
          do {
            let result = try await api.startVpn()
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      stopVpnChannel.setMessageHandler { _, reply in
        Task { @MainActor in
          do {
            let result = try await api.stopVpn()
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      invokeChannel.setMessageHandler { message, reply in
        ...
        Task { @MainActor in
          do {
            let result = try await api.invoke(requestJson: requestJsonArg)
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      queryPlatformPermissionChannel.setMessageHandler { _, reply in
        Task { @MainActor in
          do {
            let result = try await api.queryPlatformPermission()
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      requestPlatformPermissionChannel.setMessageHandler { _, reply in
        Task { @MainActor in
          do {
            let result = try await api.requestPlatformPermission()
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      getInstalledAppsChannel.setMessageHandler { _, reply in
        Task { @MainActor in
          do {
            let result = try await api.getInstalledApps()
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      useSystemExtensionChannel.setMessageHandler { _, reply in
        Task { @MainActor in
          do {
            let result = try await api.useSystemExtension()
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      queryLaunchAtLoginChannel.setMessageHandler { _, reply in
        Task { @MainActor in
          do {
            let result = try await api.queryLaunchAtLogin()
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      setLaunchAtLoginChannel.setMessageHandler { message, reply in
        ...
        Task { @MainActor in
          do {
            let result = try await api.setLaunchAtLogin(enabled: enabledArg)
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      openLaunchAtLoginSettingsChannel.setMessageHandler { _, reply in
        Task { @MainActor in
          do {
            let result = try await api.openLaunchAtLoginSettings()
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      setAppIconChannel.setMessageHandler { message, reply in
        ...
        Task { @MainActor in
          do {
            let result = try await api.setAppIcon(appIcon: appIconArg)
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      getCurrentAppIconChannel.setMessageHandler { _, reply in
        Task { @MainActor in
          do {
            let result = try await api.getCurrentAppIcon()
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
...
protocol BridgeFlutterApiProtocol {
  func vpnStatusChanged(status statusArg: VpnStatus) async throws
  func refreshVpn(result resultArg: RefreshVpnResult) async throws
}
