...
**Encryption** и создайте либо укажите пару ключей age формата X25519/hybrid.
OneXray отправляет только сохранённый публичный recipient в
`X-Age-Public-Key`; секретный ключ хранится локально, а пара повторно
используется при автоматическом обновлении.
