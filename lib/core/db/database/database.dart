...
@DriftDatabase(
  tables: [CoreConfig, Subscription, GeoData, CustomRoutingProfiles],
  daos: [CoreConfigDao, SubscriptionDao, GeoDataDao, CustomRoutingProfilesDao],
)
class AppDatabase extends _$AppDatabase {
  ...
  MigrationStrategy get migration => MigrationStrategy(
    ...
    onUpgrade: (migrator, from, to) => transaction(() async {
      ...
      // interruption between those callbacks cannot leave new columns at v1/v2.
