...
class DnsHostsCubitState {
  ...
  DnsHostsCubitState({required this.hosts, this.version = 0});

  factory DnsHostsCubitState.initial() => DnsHostsCubitState(hosts: []);

  DnsHostsCubitState bumped() =>
      DnsHostsCubitState(hosts: hosts, version: version + 1);
}
