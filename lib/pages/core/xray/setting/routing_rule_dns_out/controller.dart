...
class RoutingRuleDnsOutCubitState {
  ...
  factory RoutingRuleDnsOutCubitState.initial() =>
      RoutingRuleDnsOutCubitState(ruleState: RoutingRuleState());

  RoutingRuleDnsOutCubitState bumped() =>
      RoutingRuleDnsOutCubitState(ruleState: ruleState, version: version + 1);
}
...
class RoutingRuleDnsOutController extends Cubit<RoutingRuleDnsOutCubitState> {
  ...
  RoutingRuleDnsOutController(this.params)
    : super(RoutingRuleDnsOutCubitState.initial()) {
    _initParams();
  }
