...
class InboundTunCubitState {
  ...
  const InboundTunCubitState({required this.tunState, this.version = 0});

  factory InboundTunCubitState.initial() =>
      InboundTunCubitState(tunState: InboundTunState());

  InboundTunCubitState bumped() =>
      InboundTunCubitState(tunState: tunState, version: version + 1);
}
