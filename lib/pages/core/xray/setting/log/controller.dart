...
class XrayLogCubitState {
  ...
  const XrayLogCubitState({required this.logState, this.version = 0});

  factory XrayLogCubitState.initial() =>
      XrayLogCubitState(logState: LogState());

  XrayLogCubitState bumped() =>
      XrayLogCubitState(logState: logState, version: version + 1);
}
